...
ALTER TABLE `qp_content_attachments` ADD COLUMN `updated_at` DATETIME(3) NOT NULL, ADD COLUMN `updated_by` VARCHAR(255) NULL;
ALTER TABLE `qp_content_targets` ADD COLUMN `updated_at` DATETIME(3) NOT NULL, ADD COLUMN `updated_by` VARCHAR(255) NULL;
ALTER TABLE `qp_inquiries` ADD COLUMN `created_by` VARCHAR(255) NULL;
ALTER TABLE `qp_mass_mail_attachments` ADD COLUMN `updated_at` DATETIME(3) NOT NULL, ADD COLUMN `updated_by` VARCHAR(255) NULL;
