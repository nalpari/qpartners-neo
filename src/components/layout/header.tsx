...
export function Gnb() {
  ...
  // user 는 로그아웃/타임아웃 전환 시 QueryProvider 가 ["auth","login-user-info"] 캐시를 null 로
  // 정리하므로(query-provider.tsx 참조), user != null 단독 판정으로도 로그아웃 즉시 비로그인이 된다.
  // relatedSites 등 다른 user 파생 UI 도 같은 원리로 함께 정리된다.
