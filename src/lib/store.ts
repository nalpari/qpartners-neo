...
type PopupType = "password-reset" | "personal-info" | "two-factor-auth" | "zipcode-search" | "signup-complete" | "password-change" | "withdraw" | "member-detail" | "notice-form" | "permission-menu" | null;
