    ...
    "/admin/members/{id}": {
      ...
      put: {
        ...
        description:
          ...
          "preDetail null (삭제 회원) 경로에서는 userRole/twoFactorEnabled 변경 불가(400), status 복구만 허용. " +
                  ...
                  properties: {
                    data: {
                      ...
                      properties: {
                        ...
                        warning: { type: "string", description: "TOCTOU 사후 검증 실패/불일치 시 경고 메시지 (userRole 변경 경로 전용)" },
                      },
                    },
                  },
                },
